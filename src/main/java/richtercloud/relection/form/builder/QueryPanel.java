...
public class QueryPanel<E> extends javax.swing.JPanel {
    ...
    */
    ...
    public QueryPanel(EntityManager entityManager, Class<E> entityClass) {
        this(entityManager, entityClass, Collections.EMPTY_LIST, INITIAL_QUERY_LIMIT_DEFAULT);
    }
     ...
     * query.
     */
    public QueryPanel(EntityManager entityManager, Class<E> entityClass, List<HistoryEntry> initialHistory, int initialQueryLimit) {
        this();
        this.init0(entityManager, entityClass, initialHistory, initialQueryLimit);
    }
    ...
    private void init0(EntityManager entityManager, Class<E> entityClass, List<HistoryEntry> initialHistory, int initialQueryLimit) {
        this.entityManager = entityManager;
        this.entityClass = entityClass;
        for(HistoryEntry initialHistoryEntry : initialHistory) {
            this.queryComboBoxModel.addElement(initialHistoryEntry);
        }
        this.entityClassFields = ReflectionFormBuilder.retrieveRelevantFields(entityClass);
    ...
    public void init(EntityManager entityManager, Class<E> entityClass, List<HistoryEntry> initialHistory, int initialQueryLimit) {
        this.init0(entityManager, entityClass, initialHistory, initialQueryLimit);
    }
