...
public interface AmountMoneyUsageStatisticsStorage {
     ...
     * information.
     * @param currency
     * @throws richtercloud.reflection.form.builder.components.money.AmountMoneyUsageStatisticsStorageException if an exception during saving the changes occurs
     */
