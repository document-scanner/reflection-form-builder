...
public abstract class OnlineAmountMoneyExchangeRateRetriever implements AmountMoneyExchangeRateRetriever {
    ...
    @Override
    public void retrieveExchangeRate(Currency currency) throws AmountMoneyCurrencyStorageException {
        try {
     ...
     */
    protected abstract double fetchConversionRate(Currency currency) throws AmountMoneyCurrencyStorageException;
}
