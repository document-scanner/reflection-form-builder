 ...
 * @author richter
 */
public class FloatPrimitiveFieldHandler implements FieldHandler<Float, FieldUpdateEvent<Float>, ReflectionFormBuilder> {
    ...
    public JComponent handle(Field field,
        ...
        float fieldValue = field.getFloat(instance);
