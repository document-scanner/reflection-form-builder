 ...
 * @author richter
 */
public class MappingFieldHandler<T, E extends FieldUpdateEvent<T>, R extends ReflectionFormBuilder> implements FieldHandler<T, E, R> {
    ...
    @Override
    public JComponent handle(final Field field,
