...
public interface AmountMoneyCurrencyStorage {
     ...
     * translation.
     * @param currency the currency to translate
     * @return the translated JScience currency representation
     * @throws AmountMoneyCurrencyStorageException is an exception accessing the
     *     internal set of available currencies occurs
     */
