 ...
 * in the {@link ReflectionFormPanel}.
 *
 * @author richter
 * @see FieldInfo
 */
...
public @interface ClassInfo {
     ...
     * structure  of the data (e.g. {@code Finance accounts} might appear much
     * more clear than {@code accounts}. {@code ""} indicates that the field
     * name ought to be used (because {@code null} can't be specified).
     * @return the field name or the empty string
     */
    String name() default "";
    ...
    */
    ...
    /**
     * A path to a resource which represents an {@link Icon} which can be used
     * in components which display details of the class.
     * @return a resource path with can be used to retrieve a URL with
     * {@link ClassLoader#getResource(java.lang.String) }
     */
    String iconResourcePath() default "";
}
